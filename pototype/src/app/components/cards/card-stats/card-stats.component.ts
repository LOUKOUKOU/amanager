...
export class CardStatsComponent implements OnInit {
  ...
  set statPercentColor(statPercentColor: string) {
    this._statPercentColor =
      statPercentColor === undefined ? "" : statPercentColor;
  }
  private _statPercentColor = "";

  @Input()
  get statDescription(): string {
    return this._statDescription;
  }
  set statDescription(statDescription: string) {
    this._statDescription =
      statDescription === undefined ? "" : statDescription;
  }
  private _statDescription = "";
  ...
  set statIconName(statIconName: string) {
    this._statIconName = statIconName === undefined ? "" : statIconName;
  }
  ...
  set statIconColor(statIconColor: string) {
    this._statIconColor = statIconColor === undefined ? "" : statIconColor;
  }
